...
import 'package:ecardo_etrip/src/presentation/screens/settings/controller/id_verification_controller.dart';
...
class _IdVerificationState extends State<IdVerification> {
  ...
  Widget build(BuildContext context) {
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // etrip: KYC Level roadmap حذف شد (سطح ۱ پایه + ارتقا از طریق KYC عادی)
                          ],
                        ),
                      ),
    ...
    // etrip: _buildVerificationSection حذف شد (وابسته به ماژول‌های حذف‌شده)

  /// Build KYC progress steps (3 steps: Submit → Review → Verified)
    // etrip: _buildKycSteps حذف شد

  /// Show next steps guidance based on current KYC status
    // etrip: _buildNextStepsGuidance حذف شد
